...
description: "Cohere design system with colors, typography, components, layout, spacing, and responsive rules. Invoke when building UI matching Cohere's enterprise AI aesthetic — stark white editorial space, deep green-black product bands, soft mineral surfaces, and rounded media cards."
---
