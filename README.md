...
| **Statistik Desa**        | `[wp_desa_statistik style="classic"]` | Ringkasan demografi penduduk. Style: `classic`, `grid`, `cards`, `minimal` |
| **UMKM Desa**             | `[wp_desa_umkm limit="6"]`            | Direktori UMKM (Grid Layout)                                       |
| **Potensi Desa**          | `[wp_desa_potensi limit="3"]`         | Daftar Potensi Desa                                                |
